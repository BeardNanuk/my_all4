...
if flag_plot_inverted_stf is 1:
   ...
   plt.tight_layout(rect=[0, 0, 1.2, 4])
   fig.show()
   save_istf_complete_fn = save_istf_firstpart_fn + 'src01_rec%02d_trstar%03d_trend%03d.png' % (trace_num,inv_trace_num_star,inv_trace_num_end)
